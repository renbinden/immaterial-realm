...
import io.github.alyphen.amethyst.builder.panel.*;
...
public class AmethystBuilder extends JPanel implements Runnable {

    private static final long DELAY = 100L;

    private AmethystBuilderFrame frame;
    ...
    public AmethystBuilder(AmethystBuilderFrame frame) {
        this.frame = frame;
