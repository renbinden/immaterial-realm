...
public class ConnectionLoadingSpinnerPanel extends JPanel {
    ...
    public ConnectionLoadingSpinnerPanel(ImmaterialRealmClient client) {
        this.client = client;
        try {
    ...
    protected void paintComponent(Graphics graphics) {
        if (client.getConnectionPanel().isConnecting()) {
